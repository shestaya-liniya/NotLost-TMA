export default function Switch(prop: {
  ...
  return (
    <label className="inline-flex items-center cursor-pointer">
      ...
      />
      <div className="relative w-11 h-6 bg-secondary peer-focus:outline-none peer-focus:ring-0 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-link/30 after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-link/30 after:border-transparent after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:bg-link"></div>
      {/* <span
